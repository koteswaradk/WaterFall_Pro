 ...
 */
public class AlarmClock extends ListActivity implements OnItemClickListener, OnLongClickListener 
{

    static final String PREFERENCES = "AlarmClock";
    static final String PREF_CLOCK_FACE = "face";
    static final String PREF_SHOW_CLOCK = "show_clock";
    ImageButton /*back,*/ alarmbutton, settings;
    ...
    private void updateLayout() 
    {
        ...
        //back=(ImageButton)findViewById(R.id.back_alarmclock);
        alarmbutton=(ImageButton)findViewById(R.id.addalarm);
...
//                System.out.println("In AlarmClock, new alarm id =----------------->>>>>>>>>>>>>>>>>>>>>>>>>>>>> " + newId);
        ...
        setListAdapter(new AlarmTimeAdapter(this, mCursor));
        mAlarmsList.setVerticalScrollBarEnabled(true);
        mAlarmsList.setOnItemClickListener(this);
        mAlarmsList.setOnCreateContextMenuListener(this);
        mAlarmsList.setOnLongClickListener(this);
