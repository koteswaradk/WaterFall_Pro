...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.icrg.waterfall.alarm.ALARM_ALERT";
     ...
     */
    public static long setAlarm(Context context, int id, boolean enabled, int hour, int minutes,
